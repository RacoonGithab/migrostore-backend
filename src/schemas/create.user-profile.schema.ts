...
export const createUserProfileSchema = z.object({
    ...
    country: z
        .string()
        .regex(
            regexPatterns.COUNTRY, "Invalid country name format. Only letters, spaces, hyphens, and apostrophes are allowed."
        )
        .optional(),

    entryBasis: z
        .nativeEnum(EntryBasis, {invalid_type_error: "Invalid entry basis provided."})
        .optional(),

    citiesForJob: z
        .array(z.string().regex(regexPatterns.CITY_NAME, "Invalid city name format in list."))
        .optional()
        .default([]),

    polishLanguageLevel: z
        .nativeEnum(LanguageLevel, {invalid_type_error: "Invalid Polish language level provided."})
        .optional(),

    englishLanguageLevel: z
        .nativeEnum(LanguageLevel, {invalid_type_error: "Invalid English language level provided."})
        .optional(),
    ...
    skills: z
        .array(
            z
                .string()
                .regex(regexPatterns.SKILL_NAME, "Invalid skill name format in list.")
        )
        .optional()
        .default([]),
})
